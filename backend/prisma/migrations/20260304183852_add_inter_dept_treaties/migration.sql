...
-- CreateEnum
CREATE TYPE "BreachVerdictRuling" AS ENUM ('ACCUSED', 'ACCUSER', 'NONE');

-- CreateEnum
CREATE TYPE "BreachVerdictPenaltyMode" AS ENUM ('BOTH_MANDATORY', 'EITHER_CHOICE');
...
CREATE TABLE "BreachVerdict" (
    ...
    "ruledAgainst" "BreachVerdictRuling" NOT NULL DEFAULT 'NONE',
    "creditFine" INTEGER NOT NULL DEFAULT 0,
    "socialPenalty" INTEGER NOT NULL DEFAULT 0,
    "penaltyMode" "BreachVerdictPenaltyMode" NOT NULL DEFAULT 'BOTH_MANDATORY',
    "notes" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE INDEX "TreatyDepartment_status_idx" ON "TreatyDepartment"("status");
...
-- CreateIndex
CREATE INDEX "BreachVerdict_status_idx" ON "BreachVerdict"("status");

-- CreateIndex
CREATE INDEX "BreachVerdictVote_verdictId_idx" ON "BreachVerdictVote"("verdictId");

-- CreateIndex
CREATE INDEX "BreachVerdictVote_voterDepartmentId_idx" ON "BreachVerdictVote"("voterDepartmentId");
